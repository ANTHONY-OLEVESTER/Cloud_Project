...
class User(Base):
    ...
    date_format: Mapped[str] = mapped_column(String(20), nullable=True, default="MM/DD/YYYY")
    report_frequency: Mapped[str] = mapped_column(String(20), nullable=True, default="Weekly")
